...
{
    /// <inheritdoc />
    public partial class InitSistemaCompleto : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__19093A0B5AC9E400", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CentrosCostos", x => x.CentroCostoId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6CD9E1FC148", x => x.ProductId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ventas_CentrosCostos_CentroCostoId",
                        column: x => x.CentroCostoId,
                        principalTable: "CentrosCostos",
