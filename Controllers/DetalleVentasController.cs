...
namespace WebApplication1.Controllers
{
    public class DetalleVentasController : Controller
    {
        ...
        public DetalleVentasController(SampleDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sampleDbContext = _context.DetalleVentas.Include(d => d.Product).Include(d => d.Venta);
        ...
        public async Task<IActionResult> Create([Bind("DetalleVentaId,VentaId,ProductId,Cantidad,PrecioUnitario")] DetalleVenta detalleVenta)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "ProductId", detalleVenta.ProductId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DetalleVentaId,VentaId,ProductId,Cantidad,PrecioUnitario")] DetalleVenta detalleVenta)
        {
